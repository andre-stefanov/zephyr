...
struct stepper_ramp_api
{
	...
	/**
	 * Function pointer for retrieving the interval until the next step in the stepper motor motion profile.
	 *
	 * This variable represents a function that calculates the time interval needed for the next step
	 * of the stepper motor based on the current state of the ramp data. It is used to manage the
	 * timing of motor steps during different phases of motion, such as acceleration, steady motion,
	 * and deceleration, ensuring precise control over the motor operation.
	 */
